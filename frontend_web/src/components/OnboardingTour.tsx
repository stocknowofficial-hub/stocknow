...
const TOUR_KEY = "sn_tour_done_v1";
...
const STEP_REFERRALS  = { target: "#tour-nav-referrals",    title: "🎁 친구 초대",    content: "친구를 초대할수록 구독 기간이 늘어납니다. 초대 1명당 +7일, 최대 20명까지 혜택을 받을 수 있어요.", placement: "top", skipBeacon: true };

export default function OnboardingTour({ usFirst = false }: { usFirst?: boolean }) {
  ...
  const steps = usFirst
    ? [STEP_TELEGRAM, STEP_UPGRADE, STEP_US, STEP_KR, STEP_CONSENSUS, STEP_HISTORY, STEP_TRUMP, STEP_REFERRALS]
    : [STEP_TELEGRAM, STEP_UPGRADE, STEP_KR, STEP_US, STEP_CONSENSUS, STEP_HISTORY, STEP_TRUMP, STEP_REFERRALS];
